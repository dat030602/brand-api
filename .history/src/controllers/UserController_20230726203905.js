...
class UserController {
  ...
  async GetFeeShip(req, res) {
    ...
    const resData = await execute.executeQuery(
      `SELECT MA_TINH,MA_THANHPHO,MA_PHUONG FROM DIACHIGIAOHANG DC JOIN TINH T ON DC.TINH = T.MA_TINH JOIN THANHPHO TP ON DC.THANHPHO = TP.MA_THANHPHO JOIN PHUONG P ON DC.PHUONG = P.MA_PHUONG WHERE MA_KHACH = '${id_user}' AND STT = '${stt}'`
    );
    res.send(resData);
