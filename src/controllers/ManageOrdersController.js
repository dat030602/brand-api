		...
		const func = async () => {
			try {
				...
				await sql.connect(config).then((conn) =>
					conn
						.request()
						.query(`select d.MA_KHACH, d.MA_DONHANG, d.TRANGTHAI, CONVERT(varchar, d.NGAYTAO, 107) as NGAYTAO, d.LOAI_THANHTOAN, d.PHI_GIAO_HANG, d.TONGTIEN, dc.SONHA_DUONG, p.TEN_PHUONG, tp.TEN_THANHPHO, t.TEN_TINH
            ...
            where d.MA_KHACH like '%${req.query.id}%';select d.MA_DONHANG, ct.MA_SP, ct.STT, sp.TEN_SP, ctsp.TEN_CTSP, ctsp.GIA_BAN, ct.SOLUONG, h.HINHANH
